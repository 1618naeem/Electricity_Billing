...
public class generate_bill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            ResultSet rs = c.s.executeQuery("select * from employee where meter_number="+c1.getSelectedItem());
           ...
           rs = c.s.executeQuery("select * from tax where meter_number="+c1.getSelectedItem());
